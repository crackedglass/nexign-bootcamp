...
import com.example.crmservice.mapper.SubscriberMapper;
...
public class ManagerService {
    ...
    public SubscriberDetails createSubscriber(NewSubscriber subscriber) {
        ...
        try {
            ...
            log.error("FeignException while creating subscriber {} via BRT: Status {}, Content: {}", subscriber.getMsisdn(), e.status(), e.contentUTF8(), e);
