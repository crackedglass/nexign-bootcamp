...
public class SubscriberService {
    ...
    public void topUpOwnBalance(String msisdn, BigDecimal amount) {
        ...
        try {
            ...
            log.error("FeignException while topping up balance for subscriber {} in BRT: Status {}, Content: {}", msisdn, e.status(), e.contentUTF8(), e);
